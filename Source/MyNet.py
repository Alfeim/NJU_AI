...
@with_goto
def eval():
    maxstep,image_batch,label_batch = input_data.get_eval_image(VALPATH,BATCH_SIZE,WIDTH,HEIGHT,CHANNELS)
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            if evaltype == 'COUNT':
                datamax_,datamin_ = sess.run([datamax,datamin],feed_dict={input_x: image_batch[0]})
